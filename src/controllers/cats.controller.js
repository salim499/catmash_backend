...
// Export functions from the model to be used by the routes
// Each exported function corresponds to specific  endpoint and calls the respective model function
